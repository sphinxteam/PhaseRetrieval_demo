...
def run_alpha(alpha):
    ...
    filename = "Data/tmp/results_se_complex_matrix_real_signal_alpha_"+str(alpha)+"_uninformed.pkl"
    outfile = open(filename,'wb')
    pickle.dump({'uninformed':output_uninformed},outfile)
    outfile.close()
    return {'uninformed':output_uninformed}

print("This is the analytical uninformed SE for complex matrix + real signal")
...
filename = "Data/results_se_complex_matrix_real_signal_uninformed.pkl"
outfile = open(filename,'wb')
output = {'alphas':alphas, 'mses_uninformed':mses_uninformed}
